...
export async function GET(request: NextRequest) {
  try {
    ...
    const templateData = [
      ...
      {
        'ชื่อ สกุล': 'วิภา สุขสันต์',
        'เลขประจำตัวประชาชน': '5678901234567',
        'ชื่อผู้สนับสนุน': 'พ.ต.อ.ธนากร วิริยะกุล',
        'เหตุผล': 'มีความรู้ด้านเทคโนโลยีสารสนเทศและพัฒนาระบบงานตำรวจได้อย่างมีประสิทธิภาพ',
      },
      {
    ...
    const columnWidths = [
      { wch: 30 }, // 1. ชื่อ สกุล
      { wch: 25 }, // 2. เลขประจำตัวประชาชน
      { wch: 30 }, // 3. ชื่อผู้สนับสนุน
      { wch: 60 }, // 4. เหตุผล
    ];

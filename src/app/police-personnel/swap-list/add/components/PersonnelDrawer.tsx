...
interface PersonnelDrawerProps {
  ...
  title?: string;
  excludePersonnelId?: string; // ID ของบุคลากรที่ต้องการยกเว้น (เช่น บุคลากร A)
  ...
  const loadPersonnelWithFilter = async (
    ...
    try {
      ...
      if (excludePersonnelId) {
        pageData = pageData.filter(p => p.id !== excludePersonnelId);
      }
                              ...
                              <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1 }}>
                                ...
                                <Box>
                                  ...
                                  <Typography variant="body2">
                                    {person.age && person.age !== '-' ? `${person.age} ปี` : '-'}
                                  </Typography>
                                </Box>
                                <Box>
                            ...
                            <Box sx={{ pl: 3.5 }}>
                              <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1 }}>
                                <Box>
                                  ...
                                  <Typography variant="body2">
                                    {person.yearsOfService && person.yearsOfService !== '-' ? `${person.yearsOfService} ปี` : '-'}
                                  </Typography>
                                </Box>
                                <Box>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      ...
                      <Typography variant="body1" fontWeight={700} sx={{ color: 'white', mb: 0.25 }}>
                        ...
                        {selectedPersonnel.age && selectedPersonnel.age !== '-' && ` (${selectedPersonnel.age} ปี)`}
                      </Typography>
